...
**Fecha:** 01/09/2026
**Rama:** `HU-17--HU-18`
**Contexto:** se reportaron errores en frontend relacionados a HU-17 (Asignación de Consultorio Físico) y HU-18 (Registro de Atención sin Cita). Se investigó comparando contra `MergeConDev`, se revisó el backlog (`docs/backlog/Sprint3.csv`) y el reporte de pruebas original (`docs/T8_HU17_18_Reporte_Pruebas.md`).
